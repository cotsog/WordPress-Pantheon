	...
	function create_modal_content_default_admin() {
		$content_default = '
			<div class="modal-title">
	          <h3>' . __( 'Campaign title', WBOUNCE_TD ) . '</h3>
	        </div>

	        <div class="modal-body" style="text-align:center">
					<p><a href="//strathcom.com/" target="_blank" style="color:#009000;font-size:20px"><h4>' . __( 'Bounce by Strathcom', WBOUNCE_TD ) . '</h4></a></p>
	...
	function create_modal_content_default() {
		$content_default = '
	        ...
	        <div class="modal-body" style="text-align:center">
	        	...
	        	<p><a href="//strathcom.com/" title="WordPress plugin Bounce" target="_blank">Bounce</a> is successfully installed and triggered.</p>
