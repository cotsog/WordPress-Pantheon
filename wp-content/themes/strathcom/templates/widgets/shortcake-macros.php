<?php
/**
 * Shortcake edit screen re-used button options.
 *
 * @package WordPress
 * @subpackage StrathcomCMS
 */

$macro_icon_options          = array(
	''                       => 'none',
	'500px'                  => '500px',
	'adjust'                 => 'adjust',
	'adn'                    => 'adn',
...
$macro_button_shortcake_atts = array(
	array(
		'label' => esc_html__( 'Button 1 - URL', 'strathcom' ),
		'attr'  => 'button1_url',
		'type'  => 'text',
	),
	array(
		'label' => esc_html__( 'Button 1 - Text', 'strathcom' ),
		'attr'  => 'button1_text',
		'type'  => 'text',
	),
	array(
		'label'   => esc_html__( 'Button 1 - Icon', 'strathcom' ),
		'attr'    => 'button1_icon',
		'type'    => 'select',
		'options' => $macro_icon_options,
	),
	array(
		'label'   => esc_html__( 'Button 1 - Class', 'strathcom' ),
		'attr'    => 'button1_class',
		'type'    => 'select',
		'options' => $macro_class_options,
	),
	array(
		'label' => esc_html__( 'Button 2 - URL', 'strathcom' ),
		'attr'  => 'button2_url',
		'type'  => 'text',
	),
	array(
		'label' => esc_html__( 'Button 2 - Text', 'strathcom' ),
		'attr'  => 'button2_text',
		'type'  => 'text',
	),
	array(
		'label'   => esc_html__( 'Button 2 - Icon', 'strathcom' ),
		'attr'    => 'button2_icon',
		'type'    => 'select',
		'options' => $macro_icon_options,
	),
	array(
		'label'   => esc_html__( 'Button 2 - Class', 'strathcom' ),
		'attr'    => 'button2_class',
		'type'    => 'select',
		'options' => $macro_class_options,
	),
	array(
		'label' => esc_html__( 'Button 3 - URL', 'strathcom' ),
		'attr'  => 'button3_url',
		'type'  => 'text',
	),
	array(
		'label' => esc_html__( 'Button 3 - Text', 'strathcom' ),
		'attr'  => 'button3_text',
		'type'  => 'text',
	),
	array(
		'label'   => esc_html__( 'Button 3 - Icon', 'strathcom' ),
		'attr'    => 'button3_icon',
		'type'    => 'select',
		'options' => $macro_icon_options,
	),
	array(
		'label'   => esc_html__( 'Button 3 - Class', 'strathcom' ),
		'attr'    => 'button3_class',
		'type'    => 'select',
		'options' => $macro_class_options,
	),
	array(
		'label' => esc_html__( 'Button 4 - URL', 'strathcom' ),
		'attr'  => 'button4_url',
		'type'  => 'text',
	),
	array(
		'label' => esc_html__( 'Button 4 - Text', 'strathcom' ),
		'attr'  => 'button4_text',
		'type'  => 'text',
	),
	array(
		'label'   => esc_html__( 'Button 4 - Icon', 'strathcom' ),
		'attr'    => 'button4_icon',
		'type'    => 'select',
		'options' => $macro_icon_options,
	),
	array(
		'label'   => esc_html__( 'Button 4 - Class', 'strathcom' ),
		'attr'    => 'button4_class',
		'type'    => 'select',
		'options' => $macro_class_options,
	),
	array(
		'label' => esc_html__( 'Button 5 - URL', 'strathcom' ),
		'attr'  => 'button5_url',
		'type'  => 'text',
	),
	array(
		'label' => esc_html__( 'Button 5 - Text', 'strathcom' ),
		'attr'  => 'button5_text',
		'type'  => 'text',
	),
	array(
		'label'   => esc_html__( 'Button 5 - Icon', 'strathcom' ),
		'attr'    => 'button5_icon',
		'type'    => 'select',
		'options' => $macro_icon_options,
	),
	array(
		'label'   => esc_html__( 'Button 5 - Class', 'strathcom' ),
		'attr'    => 'button5_class',
		'type'    => 'select',
		'options' => $macro_class_options,
	),
...
$macro_secondary_button_shortcake_atts = array(
	array(
		'label' => esc_html__( 'Secondary Button 1 - URL', 'strathcom' ),
		'attr'  => 'button6_url',
		'type'  => 'text',
	),
	array(
		'label' => esc_html__( 'Secondary Button 1 - Text', 'strathcom' ),
		'attr'  => 'button6_text',
		'type'  => 'text',
	),
	array(
		'label'   => esc_html__( 'Secondary Button 1 - Icon', 'strathcom' ),
		'attr'    => 'button6_icon',
		'type'    => 'select',
		'options' => $macro_icon_options,
	),
	array(
		'label'   => esc_html__( 'Secondary Button 1 - Class', 'strathcom' ),
		'attr'    => 'button6_class',
		'type'    => 'select',
		'options' => $macro_class_options,
	),
	array(
		'label' => esc_html__( 'Secondary Button 2 - URL', 'strathcom' ),
		'attr'  => 'button7_url',
		'type'  => 'text',
	),
	array(
		'label' => esc_html__( 'Secondary Button 2 - Text', 'strathcom' ),
		'attr'  => 'button7_text',
		'type'  => 'text',
	),
	array(
		'label'   => esc_html__( 'Secondary Button 2 - Icon', 'strathcom' ),
		'attr'    => 'button7_icon',
		'type'    => 'select',
		'options' => $macro_icon_options,
	),
	array(
		'label'   => esc_html__( 'Secondary Button 2 - Class', 'strathcom' ),
		'attr'    => 'button7_class',
		'type'    => 'select',
		'options' => $macro_class_options,
	),
	array(
		'label' => esc_html__( 'Secondary Button 3 - URL', 'strathcom' ),
		'attr'  => 'button8_url',
		'type'  => 'text',
	),
	array(
		'label' => esc_html__( 'Secondary Button 3 - Text', 'strathcom' ),
		'attr'  => 'button8_text',
		'type'  => 'text',
	),
	array(
		'label'   => esc_html__( 'Secondary Button 3 - Icon', 'strathcom' ),
		'attr'    => 'button8_icon',
		'type'    => 'select',
		'options' => $macro_icon_options,
	),
	array(
		'label'   => esc_html__( 'Secondary Button 3 - Class', 'strathcom' ),
		'attr'    => 'button8_class',
		'type'    => 'select',
		'options' => $macro_class_options,
	),
	array(
		'label' => esc_html__( 'Secondary Button 4 - URL', 'strathcom' ),
		'attr'  => 'button9_url',
		'type'  => 'text',
	),
	array(
		'label' => esc_html__( 'Secondary Button 4 - Text', 'strathcom' ),
		'attr'  => 'button9_text',
		'type'  => 'text',
	),
	array(
		'label'   => esc_html__( 'Secondary Button 4 - Icon', 'strathcom' ),
		'attr'    => 'button9_icon',
		'type'    => 'select',
		'options' => $macro_icon_options,
	),
	array(
		'label'   => esc_html__( 'Secondary Button 4 - Class', 'strathcom' ),
		'attr'    => 'button9_class',
		'type'    => 'select',
		'options' => $macro_class_options,
	),
	array(
		'label' => esc_html__( 'Secondary Button 5 - URL', 'strathcom' ),
		'attr'  => 'button10_url',
		'type'  => 'text',
	),
	array(
		'label' => esc_html__( 'Secondary Button 5 - Text', 'strathcom' ),
		'attr'  => 'button10_text',
		'type'  => 'text',
	),
	array(
		'label'   => esc_html__( 'Secondary Button 5 - Icon', 'strathcom' ),
		'attr'    => 'button10_icon',
		'type'    => 'select',
		'options' => $macro_icon_options,
	),
	array(
		'label'   => esc_html__( 'Secondary Button 5 - Class', 'strathcom' ),
		'attr'    => 'button10_class',
		'type'    => 'select',
		'options' => $macro_class_options,
	),
